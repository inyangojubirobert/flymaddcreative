...
async function processPaystackPayment() {
    ...
    try {
        ...
        if (!keyLooksValid) {
            ...
            // Inform the user (friendly) and fallback to redirect when possible
            alert('Payment setup error: Paystack public key is missing or invalid. You can try the redirect flow.');
